    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            fecha_elaboracion: Yup.date()
                            ...
                            .max('12-09-2022', 'La fecha de elaboración debe ser antes de la fecha actual')
                            .min('12-09-2018', 'La fecha de elaboración no puede ser menos a los cuatro años'),
            fecha_vencimiento: Yup.date()
                            ...
                            .max('12-09-2028', 'La fecha de vencimiento no debe ser mayor a los cuatro años'),
            estado: Yup.string()
