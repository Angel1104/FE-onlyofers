...
const NuevaCuenta = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async valores=> {
            ...
            try {
                ...
                //Redirigiendo para iniciar sesion
            } catch (error) {
    ...
    return ( 
        ...
        <Layout>
            ...
            <h1 className="text-center text-2xl text-white font-ligt">Crear Nueva Cuenta</h1>
            <div className="flex justify-center mt-5">
                <div className="w-full max-w-sm bg-white rounded shadow-md">
                    <form
                        className=" px-8 pt-6 pb-3 mb-3"
